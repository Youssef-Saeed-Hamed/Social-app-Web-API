...
namespace Core_Layer.Inetrfaces.Services
{
    public interface IPostService
    {
        ...
        public Task<Response> UpdatePost(UpdatePostDto inputPost, string PostId,  string UserId);
        public Task<Response> DeletePost(DeletePostDto deletePost , string UserId);
